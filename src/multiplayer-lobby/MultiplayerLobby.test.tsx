...
describe("multiplayer lobby UI", () => {
  ...
  it("explains the secure handoff when the lobby is ready", () => {
    ...
    expect(screen.getByRole("heading", { name: "Everyone made it to the table" })).toBeInTheDocument();
    expect(screen.getByText(/Secure live-match synchronization/)).toBeInTheDocument();
  });
