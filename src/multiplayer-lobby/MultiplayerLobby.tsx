      ...
      <main className="lobby-shell" aria-labelledby="lobby-title">
        ...
        {model.screen === "entry" && (
          <section className="lobby-entry">
            <div className="lobby-intro">
              <p className="playful-kicker">Bring your own detectives</p>
              <h1 id="lobby-title">Meet around the same mystery</h1>
              <p>Create a private room or enter a six-character code from a friend. No account is required.</p>
            ...
            <div className="lobby-entry-cards">
              <form className="lobby-choice-card create-room-card" onSubmit={create}>
                ...
                <h2>Create a room</h2>
                <p>Start a fresh table and share its code.</p>
          ...
          <section className="lobby-room">
            ...
            <div className="lobby-table-card">
              <div>
                ...
                <h1 id="lobby-title">Players at the table</h1>
        ...
        {model.screen === "ready" && (
          <section className="lobby-ready-panel">
            ...
            <h1 id="lobby-title">Everyone made it to the table</h1>
            <p>The lobby is locked and ready. Secure live-match synchronization is the next multiplayer step.</p>
